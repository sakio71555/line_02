...
- [Loop 210 pg_restore Failure Diagnostics](../11_codex_tasks/210_pg_restore_failure_diagnostics_without_raw_log_exposure.md)
- [Loop 210 Obsidian Log](loop_210_pg_restore_failure_diagnostics_without_raw_log_exposure.md)
- [Loop 211 Controlled Diagnostic Restore](../11_codex_tasks/211_controlled_diagnostic_restore_with_sanitized_failure_classifier.md)
...
- [Loop 222 Obsidian Log](loop_222_pre_data_only_restore_diagnostic_execution.md)
...
- [Loop 282 Obsidian Log](loop_282_conditional_dr_restore_retry_execution_with_resolved_procedure.md)
...
- [Loop 286 Obsidian Log](loop_286_operator_provided_runtime_input_handoff.md)
...
Loop 210 status: `restore_retried=false`, `pg_restore_restore_executed=false`, `psql_executed=false`, `pg_restore_failure_category=unknown_without_raw_log`, `pg_restore_failure_category_assigned=true`, `raw_log_displayed=false`, `dump_content_displayed=false`, `row_content_displayed=false`, `secrets_recorded=false`, `loop_211_diagnostic_restore_plan_created=true`, `dr_readiness_status=not_ready_restore_failed`.
...
Loop 282 status: `loop_282_status=blocked`, `temporary_codex_direct_restore_execution_override_used=false`, `restore_procedure_exists=true`, `restore_procedure_source=new_operator_side_template`, `restore_procedure_blocker_resolved=true`, `restore_procedure_not_executable_safely=true`, `restore_retry_attempt_count=0`, `restore_retry_success=not_attempted`, `pg_restore_executed=false`, `psql_executed=false`, `supabase_connection_attempted=false`, `db_change_performed=false`, `dr_readiness_status=not_ready_restore_failed`, `next=Loop 283 DR restore execution prerequisite resolution`.
...
Loop 286 result: `loop_286_status=blocked`, `vps_helper_available=true`, `vps_helper_bash_validation_status=pass`, `vps_helper_no_input_preflight_status=blocked_safely`, `runtime_inputs_available_to_codex=false`, `runtime_input_handoff_status=not_provided`, `runtime_input_injection_method=blocked`, `helper_preflight_status=not_run`, `restore_retry_attempt_count=0`, `restore_retry_success=not_attempted`, `failure_reason=runtime_inputs_not_provided_by_operator`, `next=Loop 287 operator runtime input execution`.
