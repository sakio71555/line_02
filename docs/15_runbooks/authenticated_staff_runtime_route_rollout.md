...
| authenticated_staff route | `GET /api/admin/customers` representative route only |
...
| --- | --- | --- | --- | --- | --- |
| `GET /api/admin/customers` | customer read | representative route exists; keep in Loop 089 | revalidate if provided | `view_customers` | dev_header fallback remains until production rejection |
| `GET /api/admin/customers/:customerId` | customer read | Loop 089 | revalidate | `view_customer_detail` | other-tenant customer remains 404 |
| `GET /api/admin/customers/:customerId/timeline` | customer read | Loop 089 | revalidate | `view_timeline` | tenant + customer scoped messages |
