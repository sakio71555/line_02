...
Loop 168 resolved the previous schema-validation failure using field-name-only diagnostics.
...
Secret-safe diagnostics remain mandatory for any future OpenAI smoke.
