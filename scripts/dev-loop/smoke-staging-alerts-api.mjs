...
run("npx", [
  ...
  "vitest",
  "run",
  "tests/integration/staging-alerts-api-smoke.test.ts"
], {
  RUN_STAGING_ALERTS_SMOKE: "1",
  STAGING_ENV_FILE: envFile
});
console.log("[ok] staging alerts smoke completed");
console.log("[ok] Supabase runtime bundle used for customers/messages/alerts");
console.log("[ok] MockStaffNotifier used; real LINE/OpenAI remained disabled");
